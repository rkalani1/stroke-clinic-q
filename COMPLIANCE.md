...
Public-use boundary: Public demo must not collect or generate real patient information. Real patient intake belongs in an approved patient-communication workflow.
